...
const NODE_MODULES_TRANSFORM = false; // for esmify
...
//export variables
module.exports = { VERBOSE, PAGES_EXTENSION, AUTO_PREFIXER_TARGET, TINYPNG_API_KEY, HOST, PROXY, PORT, SRC_DIR, SRC_SCSS_DIR, SRC_JS_DIR, SRC_ASSETS_DIR, SRC_FONT_DIR, SRC_IMG_DIR, BUILD_DIR, BUILD_CSS_DIR, BUILD_JS_DIR, BUILD_IMG_DIR, BUILD_FONT_DIR, BUILD_MAPS_DIR, CSS_SOURCE_FILES, HTML_SOURCE_FILES, JS_SOURCE_FILES, IMAGE_SOURCE_FILES, FONT_SOURCE_FILES, ANOTHER_FILES, MUSTACHES, AUTO_CLOSE_TAB_ON_DISCONNECT, NODE_MODULES_TRANSFORM, STRIP_DEBUG }